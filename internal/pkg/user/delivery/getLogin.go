...
func (a *UserHandler) GetLogin(w http.ResponseWriter, r *http.Request) {
	...
	models.Process(models.LoggerFunc("Get User Info", a.UserCase.LogInfo), models.ResponseFunc(w, 200, a.UserCase.ProtoUser2User(userResponse)), models.MetricFunc(200, r, nil))
}
